...
void Mesh::InitUserMeshData(ParameterInput *pin) {
  ...
  static const Real cloud_radius = pin->GetInteger("problem","cloud_radius");
  static const Real cloud_time   = pin->GetInteger("problem","cloud_time");
