...
#
#SBATCH -J mhd20_2
#SBATCH -o mhd20_2."%j".out
#SBATCH -e mhd20_2."%j".err
...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/turb_v2/Turbulence/para_scan_Rlsh2_1000_res0_128_rseed_2_M_0.9_beta_100/

srun ./athena_turb -i athinput_turb_Rlsh2_1000_res0_256_rseed_1_M_0.9_hydro.turb -t 23:35:00
