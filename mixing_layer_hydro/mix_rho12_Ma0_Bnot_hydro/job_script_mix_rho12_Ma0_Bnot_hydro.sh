...
#
#SBATCH -J h1200
#SBATCH -o h1200."%j".out
#SBATCH -e h1200."%j".err
...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/mixing_layer_hydro/mix_rho12_Ma0_Bnot_hydro/

srun ./athena_mix -i athinput_mix_rho12_Ma0_Bnot_hydro -t 23:52:00
