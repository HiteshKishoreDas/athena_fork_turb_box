...
#
#SBATCH -J h1100
#SBATCH -o h1100."%j".out
#SBATCH -e h1100."%j".err
...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/mixing_layer_hydro/mix_rho11_Ma0_Bnot_hydro/

srun ./athena_mix -i athinput_mix_rho11_Ma0_Bnot_hydro -t 23:52:00
