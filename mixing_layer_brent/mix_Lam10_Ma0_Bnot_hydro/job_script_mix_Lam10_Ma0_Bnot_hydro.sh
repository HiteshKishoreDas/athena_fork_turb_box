...
#
#SBATCH -J h1000
#SBATCH -o h1000."%j".out
#SBATCH -e h1000."%j".err
...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/mixing_layer_brent/mix_Lam10_Ma0_Bnot_hydro/

srun ./athena_mix -i athinput_mix_Lam10_Ma0_Bnot_hydro -t 23:52:00
