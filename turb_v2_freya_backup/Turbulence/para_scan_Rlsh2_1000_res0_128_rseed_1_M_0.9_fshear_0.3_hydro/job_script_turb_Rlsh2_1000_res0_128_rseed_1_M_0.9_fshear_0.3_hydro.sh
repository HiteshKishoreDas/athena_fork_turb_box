...
#
#SBATCH -J h210.9
#SBATCH -o h210.9."%j".out
#SBATCH -e h210.9."%j".err
...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/turb_v2/Turbulence/para_scan_Rlsh2_1000_res0_128_rseed_1_M_0.9_fshear_0.3_hydro/

srun ./athena_turb -i athinput_turb_Rlsh2_1000_res0_128_rseed_1_M_0.9_fshear_0.3_hydro.turb -t 23:35:00
