...
#
#SBATCH -J m110.9
#SBATCH -o m110.9."%j".out
#SBATCH -e m110.9."%j".err
...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/turb_v2/Turbulence/para_scan_Rlsh1_500_res0_128_rseed_1_M_0.9_fshear_0.3_beta_100/

srun ./athena_turb -i athinput_turb_Rlsh1_500_res0_128_rseed_1_M_0.9_fshear_0.3_beta_100.turb -t 23:35:00
