...
#
#SBATCH -J m220.9
#SBATCH -o m220.9."%j".out
#SBATCH -e m220.9."%j".err
...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/turb_v2/Turbulence/para_scan_Rlsh2_1000_res0_128_rseed_2_M_0.9_fshear_0.3_beta_100/

srun ./athena_turb -i athinput_turb_Rlsh2_1000_res0_128_rseed_2_M_0.9_fshear_0.3_beta_100.turb -t 23:35:00
