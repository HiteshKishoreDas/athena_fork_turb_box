...
def jobscript_turb_new(i, j, template="template_dir_turb/job_script_turb_template.sh"):

    jobscript_newfile = (
        f"Turbulence/para_scan"
    ...
    work_dir = (
        ps.parent_dir + f"/Turbulence/para_scan" + ps.filename_turb_add(i, j) + "/"
    )
...
def jobscript_cloud_new(
    i, j, template="template_dir_cloud/job_script_cloud_template.sh"
):
