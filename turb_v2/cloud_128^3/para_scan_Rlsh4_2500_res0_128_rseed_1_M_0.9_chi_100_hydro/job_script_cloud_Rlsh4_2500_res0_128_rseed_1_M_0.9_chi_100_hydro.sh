...
#
#SBATCH -J hyd40_1
#SBATCH -o hyd40_1."%j".out
#SBATCH -e hyd40_1."%j".err
...
cd /ptmp/hitesh/athena_fork_turb_box/turb_v2/para_scan_Rlsh4_2500_res0_128_rseed_1_M_0.9_chi_100_hydro/

srun ./athena_turb -r ../Turbulence/para_scan_Rlsh4_2500_res0_128_rseed_1_M_0.9_hydro/Turb.final.rst -i athinput_cloud_Rlsh4_2500_res0_128_rseed_1_M_0.9_chi_100_hydro.turb -t 01:55:00
