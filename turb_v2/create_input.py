...
def input_turb_new(i, j, template='template_dir/athinput.turb_v2_template'):

    input_newfile = f'para_scan'+ps.filename_turb_add(i,j)+'/athinput_turb'+ps.filename_turb_add(i,j)+'.turb'
...
def input_cloud_new(i, j, template='template_dir/athinput.turb_v2_cloud_template'):
    ...
    input_newfile = f'para_scan'+ps.filename_cloud_add(i,j)+'/athinput_cloud'+ps.filename_cloud_add(i,j)+'.turb'
