...
#
#SBATCH -J mhd50_1
#SBATCH -o mhd50_1."%j".out
#SBATCH -e mhd50_1."%j".err
...
cd /ptmp/hitesh/athena_fork_turb_box/turb_v2/para_scan_Rlsh5_50_res0_128_rseed_1_M_0.25_chi_100_beta_100/

srun ./athena_turb -r ../Turbulence/para_scan_Rlsh5_50_res0_128_rseed_1_M_0.25_beta_100/Turb.final.rst -i athinput_cloud_Rlsh5_50_res0_128_rseed_1_M_0.25_chi_100_beta_100.turb -t 11:35:00
