...
#
#SBATCH -J hyd20_2
#SBATCH -o hyd20_2."%j".out
#SBATCH -e hyd20_2."%j".err
...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/turb_v2/Turbulence/para_scan_Rlsh2_1000_res0_128_rseed_2_M_0.9_hydro/
