...
def jobscript_turb_new(i, j,template='template_dir/job_script_turb_template.sh'):
    ...
    jobscript_newfile = f'para_scan'+ps.filename_turb_add(i,j)+'/job_script_turb'+ps.filename_turb_add(i,j)+'.sh'
...
def jobscript_cloud_new(i, j,template='template_dir/job_script_cloud_template.sh'):
    ...
    jobscript_newfile = f'para_scan'+ps.filename_cloud_add(i,j)+'/job_script_cloud'+ps.filename_cloud_add(i,j)+'.sh'
