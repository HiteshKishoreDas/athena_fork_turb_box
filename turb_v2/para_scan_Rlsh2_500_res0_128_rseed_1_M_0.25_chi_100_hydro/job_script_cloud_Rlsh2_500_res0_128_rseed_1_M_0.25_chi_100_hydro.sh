...
#
#SBATCH -J hyd20_1
#SBATCH -o hyd20_1."%j".out
#SBATCH -e hyd20_1."%j".err
...
cd /ptmp/hitesh/athena_fork_turb_box/turb_v2/para_scan_Rlsh2_500_res0_128_rseed_1_M_0.25_chi_100_hydro/

srun ./athena_turb -r ../Turbulence/para_scan_Rlsh2_500_res0_128_rseed_1_M_0.25_hydro/Turb.final.rst -i athinput_cloud_Rlsh2_500_res0_128_rseed_1_M_0.25_chi_100_hydro.turb -t 11:35:00
