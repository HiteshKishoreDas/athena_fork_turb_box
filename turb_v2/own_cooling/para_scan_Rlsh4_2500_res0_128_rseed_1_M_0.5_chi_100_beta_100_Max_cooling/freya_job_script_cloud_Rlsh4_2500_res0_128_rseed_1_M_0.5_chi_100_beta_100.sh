...
#
#SBATCH -J mhd40_1
#SBATCH -o mhd40_1."%j".out
#SBATCH -e mhd40_1."%j".err
...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/turb_v2/para_scan_Rlsh4_2500_res0_128_rseed_1_M_0.5_chi_100_beta_100/

srun ./athena_turb -r ../Turbulence/para_scan_Rlsh4_2500_res0_128_rseed_1_M_0.5_beta_100/Turb.final.rst -i athinput_cloud_Rlsh4_2500_res0_128_rseed_1_M_0.5_chi_100_beta_100.turb -t 00:25:00
