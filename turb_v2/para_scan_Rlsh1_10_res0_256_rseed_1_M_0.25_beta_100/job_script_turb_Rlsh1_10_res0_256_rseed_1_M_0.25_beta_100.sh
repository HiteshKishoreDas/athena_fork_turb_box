...
#
#SBATCH -J m110.25
#SBATCH -o m110.25."%j".out
#SBATCH -e m110.25."%j".err
...
cd /ptmp/hitesh/athena_fork_turb_box/turb_v2/para_scan_Rlsh1_10_res0_256_rseed_1_M_0.25_beta_100/

srun ./athena_turb -i athinput_turb_Rlsh1_10_res0_256_rseed_1_M_0.25_beta_100.turb -t 23:35:00
