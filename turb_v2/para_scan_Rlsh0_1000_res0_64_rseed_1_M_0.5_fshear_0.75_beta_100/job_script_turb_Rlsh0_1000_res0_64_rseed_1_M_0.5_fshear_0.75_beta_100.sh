...
#
#SBATCH -J m010.5
#SBATCH -o m010.5."%j".out
#SBATCH -e m010.5."%j".err
...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/turb_v2/para_scan_Rlsh0_1000_res0_64_rseed_1_M_0.5_fshear_0.75_beta_100/

srun ./athena_turb -i athinput_turb_Rlsh0_1000_res0_64_rseed_1_M_0.5_fshear_0.75_beta_100.turb -t 04:35:00
