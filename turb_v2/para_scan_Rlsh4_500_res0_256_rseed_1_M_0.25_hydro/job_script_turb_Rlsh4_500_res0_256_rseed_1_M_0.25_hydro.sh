...
#
#SBATCH -J h410.25
#SBATCH -o h410.25."%j".out
#SBATCH -e h410.25."%j".err
...
cd /ptmp/hitesh/athena_fork_turb_box/turb_v2/para_scan_Rlsh4_500_res0_256_rseed_1_M_0.25_hydro/

srun ./athena_turb -i athinput_turb_Rlsh4_500_res0_256_rseed_1_M_0.25_hydro.turb -t 23:35:00
