...
for i in range(len(ps.amb_rho)):
    for j in range(len(ps.Ma)):
        ...
        L_scaled_list.append(L_avg_list/P_term_strong)

        Q_strong_scaled_list.append(Q_strong/P_term_strong)
        Q_weak_scaled_list.append(Q_weak/P_term_weak)
...
# plt.plot(Da_list, L_scaled_list, label='Simulation luminosity')
