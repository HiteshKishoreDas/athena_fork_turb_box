...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/mixing_layer/mix_rho1_Ma0_B2/

# srun ./athena_mix -i athinput_mix_rho1_Ma0_B2 -t 23:52:00
srun ./athena_mix -r Turb.final.rst -t 23:52:00
