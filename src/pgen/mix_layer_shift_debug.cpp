...
void frame_shift(MeshBlock *pmb, const Real time, const Real dt,
  ...
  Real v_shift_t_new = c_s*c_s_cap;
...
void Mesh::InitUserMeshData(ParameterInput *pin) {
  ...
  if (MAGNETIC_FIELDS_ENABLED) {
    ...
    EnrollUserHistoryOutput(9, hst_front_velocity, "front_velocity", UserHistoryOperation::max);
    ...
    EnrollUserHistoryOutput(4, hst_front_velocity, "front_velocity", UserHistoryOperation::max);
