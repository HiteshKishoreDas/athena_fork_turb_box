...
cd /ptmp/mpa/hitesh/athena_fork_turb_box/mixing_layer_shift/mix_L9_Ma0_Bnot_hydro_moving/

srun ./athena_mix -i athinput_mix_L9_Ma0_Bnot_hydro_moving -t 12:52:00
